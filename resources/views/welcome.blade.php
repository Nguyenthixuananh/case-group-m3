                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            ?>
                            <li><a href="{{\Illuminate\Support\Facades\URL::to('/checkout')}}"><i
                                        class="fa fa-crosshairs"></i> Thanh toán</a></li>
                            <?php
                            }elseif($customer_id != NULL && $shipping_id != NULL){
                            ?>
                            <li><a href="{{\Illuminate\Support\Facades\URL::to('/payment')}}"><i
                                        class="fa fa-crosshairs"></i> Thanh toán</a></li>
                            <?php
                            }else{
                            ?>
                            ...
                            <li><a href="{{\Illuminate\Support\Facades\URL::to('/show-cart')}}"><i
